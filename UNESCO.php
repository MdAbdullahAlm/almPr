...
<center><img src="img/unesco.png" style="height: 100px;
            width: 400px; " /></center>
...
$result="SELECT* FROM BanPost WHERE CatagoryName='UNESCO'";
...
?>
			...
			<p style="font-size: 22px; font-weight:bold;">UNESCO HISTORY:</p>
					<img src="img/UNESCO.jpg" style="height: 350px;
            width: 630px;" />
...
Activities
:</p>
					<center><img src="img/UNESCO2.jpg" style="height: 350px;
            width: 630px; " /></center>
					<p style="font-size: 16px;"
